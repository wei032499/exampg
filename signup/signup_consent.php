        ...
        <div class="container">
            ...
            <div class="card shadow px-5 pt-4">
                <p class="line-height-1">
                    一、國立彰化師範大學(以下簡稱本校)取得您的個人資料，目的在於進行招生等教務相關工
                    作，蒐集、處理及使用您的個人資料是受到個人資料保護法及相關法令之規範。<br>
                    二、本次蒐集與使用您的個人資料，包含姓名、國民身分證統一編號(居留證號)、性別、出生
                    年月日、通訊地址、戶籍地址、住宅電話、公司電話、行動電話、E-mail、緊急聯絡人姓名、
                    緊急聯絡人電話、與緊急聯絡人關條、及應考學歷等。<br>
                    三、您同意本校因教務所需，以您所提供的個人資料確認您的身分、與您進行聯絡及同意本校於
                    您報名錄取後繼續使用您的個人資料並永久保存。<br>
                    四、依據個人資料保護法，您可就您的個人資料向本校:(1請求查詢或閱覽；(2)請求製給複製
                    本；(3)請求補充或更正；(4)請求停止蒐集、處理及利用；(5)請求刪除。但因本校執行職務或
                    業務所必需者及受其他法律所規範者，本校得拒絕之。<br>
                    五、您可以自由選擇是否提供相關個人資料，若您所提供之個人資料，經檢舉或本校發現不足以
                    確認您的身分真實性，或發生其他個人資料冒用、盜用、資料不實等情形，本校有權停止您
                    的報名資格、錄取資格等相關權利，若有不便之處敬請見諒。<br>
                    六、本同意書如有未盡事宜，依個人資料保護法或其他相關法規之規定辦理。<br>
                    七、您已瞭解此一同意書符合個人資料保護法及相關法規之要求，同意本校蒐集、處理及使用您
                    的個人資料之效果。<br>
                </p>
                <form>
