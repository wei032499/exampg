...
<head>
    ...
    <script>
        $.holdReady(true);
        var deptObj, formData = getSessionItems('signup');
                                ...
                                <div class="card p-4">
                                    ...
                                    <div class="  form-group align-items-center" style="padding-left: 15px;">
                                        <div class="row form-group align-items-center">
                                            於&nbsp;<input type="month" style="max-width:7.5rem;min-width:7.5rem" class="form-control col-sm-4" aria-describedby="ac_dateHelp" placeholder="yyyy-mm" pattern="(1\d{3}|2\d{3})-(0[1-9]|1[0-2])" name="ac_date" required>&emsp;
