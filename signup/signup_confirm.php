...
<body>
            ...
            <form class="border p-4 bg-white shadow rounded" method="POST">
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <select id="inputDept" class="form-control-plaintext" name="dept" readonly required>
                            <option selected hidden disabled></option>
                        </select>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="inputOrganize">報考組(科)別</label>
                        <select id="inputOrganize" class="form-control-plaintext" name="dept_group" readonly required>
                            <option selected hidden disabled></option>
                        </select>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <select id="inputStatus" class="form-control-plaintext" name="dept_status" readonly required>
                            <option selected hidden disabled></option>
                        </select>
                    </div>
                    <div class="form-group col-md-6">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xl">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="row col-sm align-items-center">
                                (&nbsp;<input type="text" class="form-control-plaintext col-sm-2" style="max-width: 3rem;" name="tel_o_a" readonly required>&nbsp;)&nbsp;
                                <input type="text" class="form-control-plaintext col-sm-3" style="max-width: 10rem;" id="inputTel_o" name="tel_o" readonly required>
                            </div>
                        </div>
                        <div class="row form-group">
                ...
                <fieldset class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="prove_type" id="prove1" value="1" disabled readonly required>
                            <label class="form-check-label" for="prove1">學士學位</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="prove_type" id="prove2" value="2" disabled readonly required>
                            <label class="form-check-label" for="prove2">同等學力</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="prove_type" id="prove3" value="3" disabled readonly required>
                            <label class="form-check-label" for="prove3">國家考試及格</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="prove_type" id="prove4" value="4" disabled readonly required>
    ...
    <script>
        $(function() {
            $("form [name='dept']").find('option').remove().end().append('<option value="' + sessionItems.dept + '" selected>' + sessionStorage.getItem('dept') + '</option>');
            $("form [name='dept_group']").find('option').remove().end().append('<option value="' + sessionItems.dept_group + '" selected>' + sessionStorage.getItem('dept_group') + '</option>');
            $("form [name='dept_status']").find('option').remove().end().append('<option value="' + sessionItems.dept_status + '" selected>' + sessionStorage.getItem('dept_status') + '</option>');
        });
        $(function() {
            $('form #fileLink').text('');
            $.ajax({
