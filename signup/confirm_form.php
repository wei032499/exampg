        ...
        <div class="container">
            <div class="my-3">
                ...
                <div class="row ">
                    <h3 class="col-lg" style="letter-spacing: 0.2rem;">
                        :::報名資料確認 <span style="color:red">(資料確認)</span>
                    </h3>
            ...
            <form class="border p-4 bg-white shadow rounded" method="POST">
                                ...
                                <div class="card p-4">
                                    ...
                                    <div class="  form-group align-items-center" style="padding-left: 15px;">
                                        <div class="row form-group align-items-center">
                                            於&nbsp;<input type="month" class="form-control col-sm-4" aria-describedby="ac_dateHelp" placeholder="yyyy-mm" pattern="(1\d{3}|2\d{3})-(0[1-9]|1[0-2])" name="ac_date" readonly required>
                ...
                <div class="row justify-content-center">
                    ...
                    <button type="button" style="min-width:5rem" class="btn btn-warning btn-sm col-1 mx-1" onclick="window.location.replace('./alter.php?step=2');">修改資料</button>
