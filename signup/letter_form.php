        ...
        <div class="container">
            ...
            <form id="form1" class="border p-4 bg-white shadow rounded" method="POST">
                ...
                <div><strong>研究所擬研讀方向：</strong>
                    <input class="form-control" type="text" name="research" aria-invalid="false" value="" size="30" required="required" title="" maxlength="30" /><br>
                </div>
                <div class="card ">
                            ...
                            <table class="table table-hover table-bordered ">
                                ...
                                <tbody id="mybody">
                                    <tr class="text-center" id="addrow">
                                        ...
                                        <td class="col-md-4">
                                            <input type="email" name="r_email[]" class="form-control valid" aria-invalid="false" value="" required="required" title="" />
