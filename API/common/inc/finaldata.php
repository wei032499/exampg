...
<table width="95%" border="0" cellpadding="0" cellspacing="0" bordercolor="#009900">
  <tr>
    <td width="1" bgcolor="#009900"><img src="//project.ncue.edu.tw/exampg_m/images/space.gif" width="1" height="1"></td>
    <td>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr onMouseOver="this.style.backgroundColor='#CCFFCC'" onMouseOut="this.style.backgroundColor=''">
          <td bgcolor="#009900"><img src="//project.ncue.edu.tw/exampg_m/images/space.gif" width="1" height="1"></td>
        </tr>
        <tr>
          <td></td>
        </tr>
