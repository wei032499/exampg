    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET') {
        ...
        if (oci_result($stmt, 'PROVE_TYPE') === "1") {
            $result['data'] = array(
                ...
                'conn_rel' => oci_result($stmt, 'LIAISON_REL'), 'disabled_type' => oci_result($stmt, 'CRIPPLE_TYPE'),
            ...
            $result['data'] = array(
                ...
                'ac_schol' => oci_result($stmt, 'AC_SCHOOL_NAME'), 'ac_school_type' => oci_result($stmt, 'AC_SCHOOL_TYPE'),
                'ac_dept' => oci_result($stmt, 'AC_DEPT_NAME'), 'ac_date' => oci_result($stmt, 'AC_DATE'),
                'ac_g' => oci_result($stmt, 'AC_GRADUATED'), 'ac_m_y' => oci_result($stmt, 'AC_YEAR_OF_LEAVE'), 'ac_leave_y' => oci_result($stmt, 'AC_YEAR_OF_STUDY')
            );
        } else
        ...
        $stmt = oci_parse($conn, $sql);
        $params = array($_POST['id'], $_POST['name'], $_POST['gender'], $_POST['dept'], $_POST['organize_id'], $_POST['orastatus_id'], $_POST['birthday'], $_POST['email'], $_POST['zipcode'], $_POST['address'], $_POST['tel_h_a'] . "-" . $_POST['tel_h'], $tel_o, $_POST['tel_m'], $_POST['conn_name'], $_POST['conn_tel'], $_POST['conn_rel'], $_POST['disabled_type'], $comments, $_POST['prove_type'], $payload['sn'], $_POST['zipcode2'], $_POST['address2'], $_POST['place'], $ac_school, $ac_dept, $ac_school_type, $ac_graduated, $ac_date, $ac_year_leave, $ac_year_study);
        ...
        $result['data'] = array('email' => $_POST['email'], 'card_start_date' => $CARD_START_DATE, 'card_end_date' => $CARD_END_DATE);
